    ...
    <div class="md:h-screen lg:h-screen dropdown sm:dropdown-end lg:dropdown-right">
        ...
        <nav class="dropdown-content flex flex-col justify-between w-96 sm:h-auto md:h-screen lg:h-screen bg-[#858585] px-2 py-[30px]" tabindex="0">
            ...
            <div class="sm:hidden md:flex lg:flex md:flex-col lg:flex-col justify-center align-middle h-[60px]">
                <img src="https://www.slazzer.com/static/images/home-page/banner-orignal-image.jpg" alt="" class="w-[60px] h-[60px] rounded-full object-cover sm:block md:hidden lg:hidden">
                <div class="flex flex-col justify-center gap-3">
                    <span class="px-2 text-white text-xl">Adminstrator</span>
                    <span class="px-2 text-gray-300">admin@gmail.com</span>
                </div>
