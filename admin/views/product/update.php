...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/xqzory9nvy597bn74b72f5de86nfknihmi10e9yfgi0fw699/tinymce/6/tinymce.min.js"
...
<body>
    <div class="flex justify-start items-stretch">
        ...
        <section class="w-full">
            ...
            <form action="/admin/controllers/product.php" method="post" enctype="multipart/form-data"
                class="w-full sm:p-5 md:p-10 lg:p-10 mx-auto" onsubmit="handleErrorUpdateProduct(this,event)">
                <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 items-stretch mb-10">
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" data-name="tên sản phẩm" class="input input-bordered" name="product_name"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" data-name="giá sản phẩm" class="input input-bordered" name="price"
                                value="<?= $price ?>">
                            <small class="text-base text-error error-message font-semibold"></small>
                        </div>
                        <!-- danh mục sản phẩm -->
                        <div class="form-control">
                            ...
                            <select name="category" data-name="danh mục sản phẩm" class="select select-bordered">
                                ...
                                <?php 
                                    foreach (get_all_manufacturer() as $cate) {
                                    extract($cate);
                                    if($id == $cate_id) $s="selected"; else $s="";
                        ...
                        <div class="form-control">
                            ...
                            <select name="manufacturer" data-name="nhà sản xuất" class="select select-bordered">
                                <option value="0" selected>Chọn danh nhà sản xuất</option>
                                <?php 
                                    foreach (get_all_manufacturer() as $cate) {
                                    extract($cate);
                                    if($id == $man_id) $s="selected"; else $s="";
                                    echo '<option value="'.$id.'" '.$s.'>'.$name.'</option>';
                                }
                            ?>
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" data-name="giảm giá" class="input input-bordered" name="discount"
                                value="<?= $discount ?>">
                        </div>
                        <!-- ảnh sản phẩm -->
                        <div class="form-control">
                            <label class="text-xl">Ảnh sản phẩm</label>
                            <input type="file" data-name="ảnh sản phẩm" class="file:hover:btn-primary file:btn"
                                name="product_image"><?= $image ?>
                            <small class="text-base text-error error-message font-semibold"></small>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" data-name="số sản phẩm trong kho" class="input input-bordered"
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" data-name="thời gian bảo hành" class="input input-bordered"
                                name="warranty_time" value="<?= $warranty_time ?>">
                            <small class=" text-base text-error error-message font-semibold"></small>
                        </div>
                        <!-- mô tả -->
                        <div class="form-control">
                            <label class="text-xl">Mô tả</label>
                            <textarea data-name="mô tả sản phẩm" name="description"
                ...
                <div>
                    ...
                    <button type=" submit" name="update_product" class="btn btn-lg hover:btn-primary w-auto">Update sản
                        phẩm</button>
                </div>
    ...
    const handleErrorUpdateProduct = (form, event) => {
        ...
        if (isRequired(productName, price, category, image, stock, warrantyTime, description, manufacturer) ==
            false)
            event.preventDefault()
