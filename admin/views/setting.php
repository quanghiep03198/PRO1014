    ...
    <div class="flex items-stretch">
        ...
        <section class="w-full">
            ...
            <div class="container mx-auto">
                <form action="/admin/controllers/site_setting.php" method="POST"
                    onsubmit="handleUpdateSite(this,event)">
                    <div class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5">
                        <!-- Logo 1 -->
                        <div class="form-control">
                            <label for="">Logo Header</label>
                            <input type="file" data-name="logo header"
                                class=" input input-bordered file:hover:btn-primary file:btn px-0" name="logo_header">
                            <small class="text-error error-message font-semibold"></small>
                        </div>
                        <!-- Logo 2 -->
                        <div class="form-control">
                            <label for="">Logo footer</label>
                            <input type="file" data-name="logo footer"
                                class=" input input-bordered file:hover:btn-primary file:btn px-0" name="logo_footer">
                            <small class="text-error error-message font-semibold"></small>
                        </div>
                        <!-- Email -->
                        <div class="form-control">
