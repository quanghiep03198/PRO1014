...
<div class="right">
  <div class="themmoi py-[20px] bg-[#407CB4]">
      <h2 class="lg:text-[40px]  text-[25px] ml-[50px] text-[#fff]">Update dịch vụ</h2>
  </div>
  ...
  <div class="block p-6 rounded-lg shadow-lg bg-white ">
      <form enctype="multipart/form-data" method="POST">
          <div class="grid lg:grid-cols-2 grid-cols-1 lg:gap-4">
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput123" aria-describedby="emailHelp123" placeholder="" value="<?php echo $cost ?>" >
                  <small><?php check_empty("tendm", "Tên danh mục") ?></small>
</div>
...
<button name="btn_submit" class="btn font-[400] ml-[10px] max-w-[200px]">  Update dịch vụ </button>
              </div>
