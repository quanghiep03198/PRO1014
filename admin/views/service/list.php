        ...
        <section class="w-full">
            ...
            <div class="container mx-auto">
                <div class="flex justify-end items-center my-5">
                    <a href="?page=service-create" class="btn btn-ghost "><i class="bi bi-plus text-2xl"></i><span>Thêm mới</span></a>
                </div>
                    ...
                    <tbody>
                        <?php foreach (get_all_services()  as $item) : extract($item) ?>
                            <tr class="service">
                                ...
                                <td>
                                    <a href="?page=service-update&id=<?php echo $id ?>" class="font-medium hover:text-primary">Sửa</a> /
                                    <a href="./admin/controllers/service.php?id=<?php echo $id ?>" class="font-medium hover:text-error" onclick="return confirm('Bạn chắc chắn muốn xóa danh mục sản phẩm này?')">Xóa
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
