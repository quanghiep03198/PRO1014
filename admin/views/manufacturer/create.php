...
$error =[];
 ...
 if (isset($_POST['btn_submit'])) {
  ...
  $tendm = $_POST['tendm'];
   ...
   $sqli =  "INSERT INTO `manufacturer`(`name`) VALUES ('$tendm')";
...
<div class="right">
  <div class="themmoi py-[20px] bg-[#407CB4] flex items-center justify-between">
      <h2 class="lg:text-[40px]  text-[25px] ml-[50px] text-[#fff]">Thêm mới nhà sản xuất</h2>
...
<button name="btn_submit" class="btn font-[400] ml-[10px] max-w-[200px]">  Thêm mới </button>
              </div>
