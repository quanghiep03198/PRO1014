...
<body>
    <main class="fixed w-screen h-screen z-50 center">
        <div class=" bg-gray-100 h-screen w-full flex flex-col justify-center items-center ">
            <div class="mt-24 m-auto flex flex-col justify-center items-center ">
                ...
                <div class="flex flex-col justify-center items-center tracking-widest mt-4">
                    <span class="text-gray-500 text-[100px] block"><span>4 0 4</span></span>
                    <span class="text-gray-500 text-xl">Trang bạn truy cập không tồn tại!</span>
                </div>
                <div class="flex justify-center items-center mt-10">
                    <button class="btn btn-ghost text-gray-500" onclick="window.location =`?page=home`">Về trang chủ</button>
                </div>
            </div>
        </div>
    </main>
