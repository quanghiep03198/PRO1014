        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[70%,30%] gap-10 py-10">
            <div>
                <article class="container mx-auto flex flex-col gap-5">
                    <h1 class="sm:text-xl md: text-2xl lg:text-4xl font-semibold "><?= $title ?></h1>
                    <p class="sm:text-lg text-xl font-medium "><?php echo $short_desc ?></p>
                    <div class="flex items-center gap-10">
                        <p class="text-lg">Đăng bởi: <span class="font-semibold"><?= $author ?></span></p>
                        <p class="text-lg">Ngày đăng: <span class="font-semibold"><?= $posted_date ?></span></p>
                    </div>
                    <?php echo $body ?>
                </article>
                <!-- comments  -->
