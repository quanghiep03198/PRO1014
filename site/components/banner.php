<div class="max-w-full mx-auto p-10 text-[color:(--var(primary-color))]">
    <div class="flex flex-grow justify-center gap-0 items-center sm:flex-col-reverse md:flex-row lg:flex-row">
        <div class="flex basis-1/2 flex-col gap-5">
            ...
            <div class="mt-5">
                <a href="?page=product" class="btn btn-outline sm:btn-md sm:btn-block lg:btn-lg lg:btn-wide ">Xem ngay</a>
            </div>
        </div>
        <picture>
